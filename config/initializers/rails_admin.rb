RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Rails Admin Without Devise', 'Admin']
  ...
  # config.excluded_models = ['Account', 'Invite', 'Role', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Account', 'Invite', 'Role', 'User']
